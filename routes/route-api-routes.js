...
module.exports = function(app) {
  ...
  app.get('/api/routes', async (req, res) => {
    // Add sequelize code to find all Movies, and return them to the user with res.json
    const query = {};
  ...
  // Get route for returning Movies of a specific category
  app.get('/api/routes/category/:category', async (req, res) => {
    // Add sequelize code to find all Movies where the category is equal to req.params.category,
